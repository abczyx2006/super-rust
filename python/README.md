...
- pack of python extensions for better development , all extensions packaged are given below.
...
2. type `ext install abczyx2006.python-pack`

3. press <kbd>Enter</kbd>

### contribute

- repo: [`url`](https://github.com/abczyx2006/rust-pack/tree/main/python)
