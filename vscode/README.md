...
![Installs](https://vsmarketplacebadges.dev/installs-short/abczyx2006.vscode-pack.svg?&logo=visualstudiocode&color=A3BE8C)
![Version](https://vsmarketplacebadges.dev/version-short/abczyx2006.vscode-pack.svg?&logo=visualstudiocode&color=A3BE8C&label=version)

</div>

### about

- pack of vscode extensions for better development , all extensions packaged are given below.
...
2. type `ext install abczyx2006.vscode-pack`

3. press <kbd>Enter</kbd>

### contribute

- repo: [`url`](https://github.com/abczyx2006/rust-pack/tree/main/vscode)
